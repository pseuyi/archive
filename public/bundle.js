...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FixedNav = __webpack_require__(225);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          null,
	          'freda suyi nada/ding'
	        ),
	        this.props.children,
	        _react2.default.createElement(_FixedNav2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavRow = __webpack_require__(224);

	var _NavRow2 = _interopRequireDefault(_NavRow);
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_NavRow2.default, { links: [{ text: 'about' }, { text: 'projects' }, { text: 'sketches' }, { text: 'contact' }] })
	      );
	    }
	  }]);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.props.links && this.props.links.map(function (link, idx) {
	          return _react2.default.createElement(
	            'div',
	            { key: idx, className: 'col-xs-12 col-sm-6 col-md-3 col-lg-3' },
	            _react2.default.createElement(
	              'div',
	              { className: 'nav box' },
	              _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDraggable = __webpack_require__(226);
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'fixed-nav', onClick: this.startDrag },
	          this.state.drag ? _react2.default.createElement(
	            'p',
	            null,
	            'pick me up'
	          ) : _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', { className: 'nav-icon', src: 'icons/home.png' }),
	          _react2.default.createElement('img', { className: 'nav-icon', src: 'icons/file.png' }),
	          _react2.default.createElement('img', { className: 'nav-icon', src: 'icons/happy.png' }),
	          _react2.default.createElement('img', { className: 'nav-icon', src: 'icons/mail.png' })
	        )
	      );
	    }
	  }]);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'a) freda nada (b. freda suyi ding) is a chinatown, nyc based programmer interested in topics surrounding web3, digital labor, new media, and frameworks for social progress.'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          'b) currently a teaching fellow for an immersive online code school modeled after stanford\'s vr lab. using javascript, express, node, sql, angular, react, web audio, a-frame, three.js.'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          'c) formerly a management consultant in silicon valley, freelance writer @ NEW INC, intern @ PS1, data analyzer @ AOL, student @ nyu.'
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Project = __webpack_require__(229);
	...
	var _class = function (_Component) {
	  ...
	  function _class() {
	    ...
	    _this.state = { projects: _projects2.default };
	    return _this;
	  }
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'row' },
	        projects && projects.map(function (proj, idx) {
	          return _react2.default.createElement(
	            'div',
	            { key: idx, className: 'col-xs-12 col-sm-6 col-md-3 col-lg-3' },
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { href: '' + proj.url },
	                _react2.default.createElement('img', { className: 'thumbnail', src: proj.imgsrc ? proj.imgsrc : 'images/' + proj.name + '.png', alt: proj.name + ' thumbnail' }),
	                _react2.default.createElement(
	                  'h3',
	                  null,
	                  proj.name
	              ...
	              _react2.default.createElement(
	                'a',
	                { href: proj.giturl, className: 'octicon' },
	                '\< \/ \>'
	              ),
	              _react2.default.createElement(
	                'p',
